...
public class LocalizationCoverageTests
{
    ...
    private static string ProjectRoot
    {
        get
        {
            ...
            while (dir is not null && !File.Exists(Path.Combine(dir.FullName, "Sbroglione.sln")))
                dir = dir.Parent;
            if (dir is null)
                throw new InvalidOperationException("Sbroglione.sln non trovato risalendo da " + AppContext.BaseDirectory);
            return Path.Combine(dir.FullName, "Sbroglione");
        }
    }
